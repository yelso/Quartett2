...
struct Color {
    ...
    static let blue1 = UIColor(red:0.88, green:0.97, blue:0.91, alpha:1.0)
    static let blue2 = UIColor(red:0.01, green:0.33, blue:0.49, alpha:1.0)
    static let blue3 = UIColor(red:0.66, green:0.91, blue:0.86, alpha:1.0)
    static let blue4 = UIColor(red:0.01, green:0.75, blue:0.77, alpha:1.0)
    static let blue5 = UIColor(red:0.01, green:0.52, blue:0.66, alpha:1.0)
    static let blue6 = UIColor(red:0.00, green:0.01, blue:0.07, alpha:1.0) //UIColor(red:0.01, green:0.01, blue:0.09, alpha:1.0)//UIColor(red:0.07, green:0.07, blue:0.12, alpha:1.0) //UIColor(red:0.13, green:0.13, blue:0.20, alpha:1.0)//UIColor.white//UIColor(red:0.88, green:0.95, blue:0.97, alpha:1.0)
